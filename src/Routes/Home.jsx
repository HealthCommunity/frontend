...
function Home(){
    ...
    return (
        <>
            ...
            <HomeDiv>
                <LeftDiv>
                   <BoardNav border={whereboard === 0 && "0 20px 20px 0 rgb(32 33 39 / 5%)"} click={onExersise} name={"운동 게시판"} summary={"다른 사람의 운동 경험을 확인해보세요!"}/>
                   <BoardNav border={whereboard === 1 && "0 20px 20px 0 rgb(32 33 39 / 5%)"} click={onThree} name={"3대 운동 게시판"} summary={"다른 사람의 3대 능력을 확인해보세요!"}/>
                   <BoardNav border={whereboard === 2 && "0 20px 20px 0 rgb(32 33 39 / 5%)"} click={onFree} name={"자유 게시판"} summary={" 운동경험, 운동 팁, 식단 등 자유로운 게시판입니다"}/>
                </LeftDiv>
                <RightDiv>

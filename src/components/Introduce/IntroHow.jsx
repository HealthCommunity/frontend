...
function IntroHow() {
  return (
    <>
      ...
      <IntroSeparateHowH1>
        제작과정은 GitHub 와 Notion을 참조해주세요
      </IntroSeparateHowH1>
      <IntroHowLink>
        <IntroLink href="https://github.com/HealthCommunity" target="_blank">
          <FaGithub
            style={{ margin: "0 50px", width: "200px", height: "200px" }}
          />
        </IntroLink>
        <IntroLink
          href="https://www.notion.so/d5155ebe8e9c46578afcc8b29addb88c"
          target="_blank"
        >
          <SiNotion
            style={{ margin: "0 50px", width: "200px", height: "200px" }}
